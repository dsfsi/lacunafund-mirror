/**
 * English content bundle — the source of truth for site copy.
 * Other locales (es, fr, sw) mirror this exact shape.
 */
...
export const en = {
  ...
  site: {
    ...
    shortTagline: "Labeled data for social impact",
    footerBlurb: "in low- and middle-income contexts globally.",
    footerLegal: "a funder collaborative for equitable machine learning data.",
  },
  ...
  ui: {
    ...
    videoThumbnailPlaceholder: "Video Thumbnail Placeholder",
    logoPlaceholder: "Logo Placeholder",
    portraitPlaceholder: "Portrait Placeholder",
    funderLogosPlaceholder: "Funder Logos Placeholder",
    logoAlt: "logo",
    ...
    language: "Language",
    explore: "Explore",
    policiesAndSecretariat: "Policies & Secretariat",
    secretariatLink: "Meridian Institute (Secretariat)",
    apply: "Apply",
    learnMore: "Learn more",
    seeDatasets: "See datasets",
    exploreDatasetsLink: "Explore datasets",
    goToApply: "Go to Apply",
    searchDatasets: "Search datasets by title, author or keyword",
    showing: "Showing",
    of: "of",
    noDatasetsMatch: "No datasets match",
    noDatasetsListed: "No published datasets are listed for this domain yet.",
    openDataset: "Open dataset",
  },

  home: {
    badge: "Labeled data for social impact",
    headline:
    ...
    whyEyebrow: "Why Lacuna Fund",
    whyTitle: "A first-of-its-kind funder collaborative",
    aboutButton: "About the Fund",
    intro: [
    ...
    statsTitle: "The Fund in numbers",
    stats: {
      datasets: "Published datasets listed",
      domains: "Domain areas funded",
      panels: "Technical advisory panels",
      funders: "Funding partners",
    },
    domainsEyebrow: "Domains",
    domainsTitle: "Filling in the international data map",
    domainsDescription: "Lacuna Fund grants in four domain areas with key data needs.",
    fundersEyebrow: "Funding partners",
    fundersTitle: "Supported by a multi-stakeholder collaborative",
    fundersButton: "Learn about our funders collaborative",
    ...
    pillarsEyebrow: "Start here",
    pillarsTitle: "Explore the Fund",
    pillars: [
      {
        title: "Our Structure",
    ...
    applyPanelTitle: "Apply for funding",
    applyPanelBody:
  ...
  about: {
    ...
    domainLabel: "Domain",
    grantmakingEyebrow: "Grantmaking",
    grantmakingTitle: "Our Grantmaking",
    grantmaking: [
    ...
    ambitionTitle: "Galvanizing a step change in machine learning's potential worldwide.",
    aimsTitle: "Lacuna Fund aims to:",
    aims: [
    ...
    nextTitle: "Apply",
    nextCardTitle: "See open, upcoming, and past RFPs",
    nextCardBody: "More information about domain areas and the application process.",
  },
  ...
  datasetsPage: {
    ...
    intro:
      "Lacuna Fund grantees produce openly accessible, locally owned labeled datasets. Explore released datasets in each domain area.",
    stats: {
      agriculture: "Agriculture datasets",
      language: "Language datasets",
      health: "Health datasets",
      domains: "Domain areas",
    },
    chooseEyebrow: "Domains",
    chooseTitle: "Choose a domain",
    releasedCount: "released datasets",
    grantmakingUnderway: "Grantmaking underway",
    licensingEyebrow: "Licensing",
    licensingTitle: "How to use these datasets",
    licensingPanelTitle: "Open by design",
    licensingPanelBody:
      "All datasets produced with Lacuna Fund support are locally developed and owned, and openly accessible to the international community while adhering to best practices regarding ethics and privacy.",
  },

  domainPage: {
    statReleased: "Released datasets",
    statAuthors: "Contributing authors",
    statAccess: "Access & licensing",
    statAccessValue: "Open",
    statDomain: "Domain area",
    whyEyebrow: "Why it matters",
    whyTitle: "and machine learning",
    locallyOwnedTitle: "Locally owned by design",
    locallyOwnedBody:
    ...
    spotlightTitle: "Featured dataset",
    spotlightBadge: "Recently listed",
    releasedEyebrow: "Released datasets",
    releasedTitle: "datasets",
    inProgressTitle: "Datasets in progress",
    searchHint:
      "Search the collection, then expand an entry to see authors, descriptions and access links.",
    comingSoonTitle: "Coming soon",
    comingSoonBody:
      "Grantmaking in this domain is guided by dedicated technical advisory panels. Released datasets will be listed here as projects complete.",
  },
  ...
  governance: {
    ...
    structureTitle: "Who governs the Fund",
    bodies: [
      {
        title: "Funders",
    ...
    secretariatButton: "Learn more about Meridian Institute",
    documentsEyebrow: "Documents",
    documentsTitle: "Key Policies and Resources",
    policies: [
      {
  ...
  steeringCommittee: {
    ...
    compositionBody:
      "A representative committee of 5\u20139 members, with a balance of perspectives that serves the principles of Lacuna Fund.",
    membersEyebrow: "Members",
    membersTitle: "Committee members",
    memberRole: "Steering Committee Member",
  ...
  taps: {
    ...
    responsibilitiesTitle: "What TAPs do",
    identifyTitle: "Identify and refine",
    identifyBody:
      "TAP members identify data gaps and refine requests for proposals within each domain area.",
    reviewTitle: "Review and select",
    reviewBody:
      "Panels review and select proposals for funding, outline insights from the funding process, and make recommendations for future funding considerations.",
    timelineEyebrow: "Timeline",
    timelineTitle: "Technical Advisory Panels (TAPs)",
    timelineDescription: "Panels convened for each request for proposals, most recent first.",
    panelLabel: "Technical Advisory Panel",
    panels: [
  ...
  apply: {
    ...
    intro:
      "See open, upcoming, and past RFPs, as well as more information about domain areas and the application.",
    domainsEyebrow: "Domain areas",
    domainsTitle: "Where we grant",
    ...
    processTitle: "How the RFP process works",
    process: [
      {
        step: "01",
    ...
    resourcesTitle: "Key policies for applicants",
