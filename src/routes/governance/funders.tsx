...
const funderLogos: Record<string, string> = {
  ...
  "Patrick J. McGovern Foundation": patrickLogo,
        ...
        aside={
          <div className="grid grid-cols-2 gap-3 rounded-2xl bg-muted/50 p-4">
            {funders.list.map((funder) => (
              <div
                key={funder.name}
                className="flex aspect-[3/2] items-center justify-center rounded-lg bg-background p-3"
              >
                <img
                  src={funderLogos[funder.name]}
            ...
            {funders.list.map((funder, i) => (
              ...
              >
                ...
                <div className="grid gap-5 sm:grid-cols-[170px_1fr] sm:items-start">
                  <div className="flex aspect-[3/2] items-center justify-center rounded-xl bg-muted/50 p-5">
                    <img
                      src={funderLogos[funder.name]}
                      alt={`${funder.name} logo`}
                      className="h-full w-full object-contain"
